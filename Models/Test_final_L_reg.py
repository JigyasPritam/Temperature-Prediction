...
L_reg_max = LinearRegression()
L_reg_max.fit(X_train, Y_train_max)

L_reg_min = LinearRegression()
L_reg_min.fit(X_train, Y_train_min)

# Make predictions
Y_pred_test_max = L_reg_max.predict(X_test)
Y_pred_train_max = L_reg_max.predict(X_train)
Y_pred_test_min = L_reg_min.predict(X_test)
Y_pred_train_min = L_reg_min.predict(X_train)
